# Connect Your Wallet to DutySwap

![](../.gitbook/assets/how-to-connect-wallet-header.png)

You've made a wallet and gotten your BEP20 tokens, now you just need to connect your wallet with DutySwap and you're good to go!

Check out the steps below for how to connect each of our recommended wallets to DutySwap.
...
1. Scroll down to "Popular" and tap on "DutySwap". You can also find it in "Exchanges".

![](<../.gitbook/assets/image (66).png>)

1. A new page will open with the DutySwap logo and some information. Tap the **Connect** button.

![](<../.gitbook/assets/image (67).png>)

1. DutySwap will open up. If you see a **Connect** button in the top-right tap that and tap **Trust Wallet** from the list.

{% hint style="warning" %}
If you find you are unable to connect at step 4, go back to the DApps menu and find "DutySwap" again. Using "Duty Swap" from the "History" section may result in the same problem.
{% endhint %}

### iOS

To connect to DutySwap through iOS, Trust Wallet have prepared a detailed guide on using WallteConnect.

Read the [Trust Wallet guide to connecting to DutySwap via WalletConnect](https://community.trustwallet.com/t/using-walletconnect-to-access-dutyswap/212307).
...
To connect MetaMask to DutySwap follow the steps below.
...
1. Type "DutySwap" into the search field and start the search. The top result will be the DutySwap exchange. Tap to enter it.
2. You wallet will ask you to connect. Tap **Connect** to connect to DutySwap.
...
5. Type "DutySwap.finance" into the search field and start the search.\
...
1. You'll see a DApp browser page open. Under "Recommended", find and tap the **DutySwap** button. If you can't see DutySwap under Recommended, you can also find it under "BSC".

![](<../.gitbook/assets/image (79).png>)

1. A window will open saying that you will be opening a third party DApp. Tap **I got it** and you'll be taken to DutySwap's website connected to your wallet.
...
1. You'll see a DApp browser page open. Under "DeFi", find and tap the **DutySwap** button. If you can't see DutySwap under DeFi, you can also find it under "BSC".

![](<../.gitbook/assets/image (83).png>)

1. A window will open saying that you will be opening a third party DApp. Tap **Confirm** and you'll be taken to DutySwap's website connected to your wallet.
...
1. Visit the [DutySwap website](https://duty.exchange). In the top right corner you'll see the **Connect** button. Click it.
...
1. Visit the DutySwap website. In the top-right, click **Connect**.
...
4. Visit the[ ](https://duty.exchange)[duty.exchange](https://duty.exchange), In the top right corner you'll see the **Connect** button. Click it.\
...
1. On the list of BSC DApps, you'll find DutySwap links. Click a **DutySwap** link.

![](<../.gitbook/assets/image (92).png>)

{% hint style="warning" %}
Make sure you don't choose the "DutySwap data analysis" option. If you do, you will not be able to connect.
{% endhint %}

1. Your browser will open a DutySwap tab and attempt to connect to Token Pocket.
