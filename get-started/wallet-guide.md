...
To get started on DutySwap, the first thing you'll need is to set up a wallet that supports BNB Smart Chain (BSC). Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
...
This comparison table gives an overview of the most popular mobile wallets used with DutySwap.
...
* Additional steps needed to use with BNB Smart Chain and DutySwap
...
* No additional steps needed to use with BNB Smart Chain and DutySwap.
...
To connect to BNB Smart Chain and use DutySwap, you can follow the TokenPocket section of our Connect Your Wallet to DutySwap guide [https://docs.duty.exchange/get-started/connection-guide](https://docs.duty.exchange/get-started/connection-guide).
...
The genuine DutySwap site and staff will never ask you to input your seed phrase.\*\*
{% endhint %}
...
This comparison table gives an overview of the most popular desktop wallets used with DutySwap.
...
* Supports BNB Smart Chain by default, making using DutySwap easy
* Supports a large number of languages
* Hardware wallet compatible
...
And that’s it, all done! You can follow our [Connect Your Wallet to DutySwap guide](https://docs.duty.exchange/get-started/connection-guide) to connect to BNB Smart Chain and DutySwap.
{% endtab %}
{% endtabs %}
