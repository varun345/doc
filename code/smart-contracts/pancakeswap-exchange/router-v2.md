...
{% hint style="warning" %}
DutySwap is based on Uniswap v2. Read the [Uniswap v2 documentation](https://docs.uniswap.org/protocol/V2/introduction).\
...
**Contract name:** DutyRouter\
**Contract address:** 0x10ED43C718714eb63d5aA57B78B54704E256024E

View [DutyRouter.sol on GitHub](https://github.com/duty.exchange/duty-swap-periphery/blob/master/contracts/DutyRouter.sol).

View the [DutySwap: Router v2 contract on BscScan](https://bscscan.com/address/0x10ed43c718714eb63d5aa57b78b54704e256024e).
...
Returns the canonical address for [DutyFactory](https://bscscan.com/address/0xca143ce32fe78f1f7019d7d551a6402fc5350c73).
...
```
import '@uniswap/v2-core/contracts/interfaces/IDutyRouter.sol';
```
...
// File: contracts\interfaces\IDutyRouter02.sol
