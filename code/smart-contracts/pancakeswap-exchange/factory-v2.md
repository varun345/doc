...
{% hint style="warning" %}
DutySwap is based on Uniswap v2. Read the [Uniswap v2 documentation](https://uniswap.org/docs/v2/).  
...
**Contract name:** DutyFactory  
**Contract address:** 0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73

View [DutyFactory.sol on GitHub](https://github.com/duty.exchange/duty-swap-core/blob/master/contracts/DutyFactory.sol).

View the [DutySwap: Factory v2 contract on BscScan](https://bscscan.com/address/0xca143ce32fe78f1f7019d7d551a6402fc5350c73).
...
```text
import '@uniswap/v2-core/contracts/interfaces/IDutyFactory.sol';
```
